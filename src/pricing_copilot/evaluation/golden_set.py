...
GOLDEN_CASES: list[GoldenCase] = [
    ...
    GoldenCase(
        ...
        kind=CaseKind.CHAT,
        description="Claims performance produces a direct evidence-based answer.",
    ...
    GoldenCase(
        ...
        category=CaseCategory.NORMAL,
        kind=CaseKind.CHAT,
        description="Conversion performance produces a direct evidence-based answer.",
    ...
    GoldenCase(
        ...
        category=CaseCategory.NORMAL,
        kind=CaseKind.CHAT,
        description="Competitor question produces an interpreted answer.",
